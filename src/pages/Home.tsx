...
const Home = () => {
  const barImages = [
    "https://images.unsplash.com/photo-1577372970039-2ac351969c05?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2076&q=80",
    "https://images.unsplash.com/photo-1605030753481-32656e414f95?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1976&q=80",
    "https://images.unsplash.com/photo-1597290282695-edc43d0e7129?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2075&q=80"
  ];
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative h-[90vh] min-h-[600px] overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(${barImages[0]})` }}></div>
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col justify-center items-center text-center text-tavern-light z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-6 max-w-4xl animate-fade-in" style={{ animationDelay: "200ms" }}>
            Ten Cat Tavern
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-2xl text-tavern-light/90 animate-fade-in" style={{ animationDelay: "400ms" }}>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1 animate-fade-in-left">
              <SectionHeading
                subtitle="About Us"
                title="A Neighborhood Tradition Since 1989"
                alignment="left"
              />
      ...
      <section className="py-20 px-4 bg-tavern-light/50">
        <div className="container mx-auto">
          <SectionHeading
            ...
            title="What Makes Ten Cat Special"
            description="From pool tables to private events, Ten Cat Tavern offers a variety of amenities to make your visit memorable."
            className="mb-12"
          />
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <SectionHeading
            ...
            description="Get a glimpse of what Ten Cat Tavern has to offer. From our cozy interior to lively events, these images showcase our unique tavern atmosphere."
            className="mb-12"
          />
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/contact">
                <Button 
                  size="lg" 
                  className="w-full sm:w-auto bg-tavern-primary hover:bg-tavern-primary/90 text-tavern-light button-tavern transition-all duration-300"
                >
                  Contact Us
                </Button>
              </Link>
              ...
              >
                <Button 
                  variant="outline" 
                  size="lg" 
                  className="w-full sm:w-auto border-tavern-light/30 text-tavern-light hover:bg-tavern-light/10 hover:border-tavern-light/50 button-tavern transition-all duration-300"
                >
                  Get Directions
                </Button>
              </a>
